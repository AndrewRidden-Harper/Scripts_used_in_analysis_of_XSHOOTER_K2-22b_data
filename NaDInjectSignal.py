...
#    I1anoise = 1/np.std(d3[:,I1cols[0]])
#    I1bnoise = 1/np.std(d3[:,I1cols[1]])
#    
#    I2anoise = 1/np.std(d3[:,I2cols[0]])
#    I2bnoise = 1/np.std(d3[:,I2cols[1]])
#    
#    I3anoise = 1/np.std(d3[:,I3cols[0]])
#    I3bnoise = 1/np.std(d3[:,I3cols[1]])
#    
#    I4anoise = 1/np.std(d3[:,I4cols[0]])
#    I4bnoise = 1/np.std(d3[:,I4cols[1]])
...
#    Weight2 = 1.0    
    ...
    I1meannoise = np.mean([I1anoise,I1bnoise])**2
    I2meannoise = np.mean([I2anoise,I2bnoise])**2
    I3meannoise = np.mean([I3anoise,I3bnoise])**2
    I4meannoise = np.mean([I4anoise,I4bnoise])**2
    
    SumOfWeights = I1meannoise + I2meannoise + I3meannoise + I4meannoise

#    I1meannoise_norm = 1.0  
#    I2meannoise_norm = 1.0
#    I3meannoise_norm = 1.0
#    I4meannoise_norm = 1.0
    ...
    #planetspec = OLD np.sum(d4[starttrans:endtrans+1,:],axis=0)  ## Should be an average 
    ...
    return planetspec,phase,radv,translims,numorbits,[I1anoise,I1bnoise,I2anoise, I2bnoise, I3anoise, I3bnoise, I4anoise, I4bnoise],InjectedPartsSTD
...
for pcatoremove in pcavect:       
    ...
    n1spec,n1phase,n1radv,n1translims,n1numorbits,n1linenoise,n1InjectedPartSTD = process(name,data,wavelength,jd,pcatoremove,width,SpecialTransLims,vorbital='calculate',ToInject=ToInjectTrueFals,injectStrength=InjectionStrength,ModelRadialVelocity=DopplerShiftForModel)    
    
    n1specNoInject,n1phaseNoInject,n1radvNoInject,n1translimsNoInject,n1numorbitsNoInject,n1NoInjectlinenoise,n1NoInjectInjectedPartSTD = process(name,data,wavelength,jd,pcatoremove,width,SpecialTransLims,vorbital='calculate',ToInject=False,injectStrength=InjectionStrength)    
    ...
    n2spec,n2phase,n2radv,n2translims,n2numorbits,n2linenoise,n2InjectedPartSTD = process(name,data,wavelength,jd,pcatoremove,width,SpecialTransLims,vorbital='calculate',ToInject=ToInjectTrueFals,injectStrength=InjectionStrength,ModelRadialVelocity=DopplerShiftForModel)    
    
    n2specNoInject,n2phaseNoInject,n2radvNoInject,n2translimsNoInject,n2numorbitsNoInject, n2NoInjectlinenoise, n2NoInjectInjectedPartSTD = process(name,data,wavelength,jd,pcatoremove,width,SpecialTransLims,vorbital='calculate',ToInject=False,injectStrength=InjectionStrength)    
#    
#    
#    
#
    ...
    n3spec,n3phase,n3radv,n3translims,n3numorbits,n3linenoise,n3InjectedPartSTD = process(name,data,wavelength,jd,pcatoremove,width,SpecialTransLims,vorbital='calculate',ToInject=ToInjectTrueFals,injectStrength=InjectionStrength,ModelRadialVelocity=DopplerShiftForModel)    
    
    n3specNoInject,n3phaseNoInject,n3radvNoInject,n3translimsNoInject,n3numorbitsNoInject,n3NoInjectlinenoise,n3NoInjectInjectedPartSTD = process(name,data,wavelength,jd,pcatoremove,width,SpecialTransLims,vorbital='calculate',ToInject=False,injectStrength=InjectionStrength)    
    ...
    n4spec,n4phase,n4radv,n4translims,n4numorbits,n4linenoise,n4InjectedPartSTD = process(name,data,wavelength,jd,pcatoremove,width,SpecialTransLims,vorbital='calculate',ToInject=ToInjectTrueFals,injectStrength=InjectionStrength,ModelRadialVelocity=DopplerShiftForModel)    

    n4specNoInject,n4phaseNoInject,n4radvNoInject,n4translimsNoInject,n4numorbitsNoInject,n4NoInjectlinenoise,n4NoInjectInjectedPartSTD = process(name,data,wavelength,jd,pcatoremove,width,SpecialTransLims,vorbital='calculate',ToInject=False,injectStrength=InjectionStrength)    
...
STDOfInjectionPartBeforeDownWeightingNoisyColumns = np.mean([np.mean(n1NoInjectInjectedPartSTD),np.mean(n2NoInjectInjectedPartSTD),np.mean(n3NoInjectInjectedPartSTD),np.mean(n4NoInjectInjectedPartSTD)])/np.sqrt(2)  ## Since the two lines are combined 
